-- Idempotente: complementa 170000 si se aplicó una versión anterior sin seed ni comentarios.
-- También sirve tras rollback manual (scripts/rollback_client_license_plans.sql).
